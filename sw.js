const CACHE_NAME = 'prep-mate-v30'; // v30: исправления поиска, тренажёров и мобильного интерфейса
const ASSETS = [
  './',
  './index.html',
  './style.css',
  './js/core.js?v=30',
  './js/study-data.js?v=30',
  './js/study-tools.js?v=30',
  './js/practice.js?v=30',
  './js/training.js?v=30',
  './js/reading.js?v=30',
  './js/articles-ui.js?v=30',
  './js/mobile-pwa.js?v=30',
  './js/app.js?v=30',
  './manifest.json',
  './logo.png',
  './favicon.ico',
