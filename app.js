...
const MARKERS = {
    federal: [
        'регулирование', 'федеральный', 'федеральные', 'основы', 'судоустройство', 'прокуратура',
        'амнистия', 'помилование', 'оборона', 'безопасность', 'валютное', 'кредитное', 'таможенное',
        'денежная эмиссия', 'стандарты', 'метрологическая', 'геодезия', 'картография',
        'государственные награды', 'внешняя политика', 'международные договоры', 'ядерная энергетика',
        'космос', 'федеральный бюджет', 'уголовное', 'гражданское', 'уголовно-процессуальное',
        'гражданско-процессуальное', 'арбитражное', 'валюта', 'эмиссия', 'финансовое',
        'федеральный транспорт', 'федеральные пути сообщения', 'информация', 'связь',
        'деятельность в космосе', 'внешнеэкономические', 'метеорология', 'статистика',
        'патентное', 'авторское', 'официальный статистический учёт'
    ],
    joint: [
        'совместном', 'обеспечение', 'защита', 'координация', 'охрана', 'общие принципы',
        'общие вопросы', 'административное', 'трудовое', 'семейное', 'жилищное',
        'адвокатура', 'нотариат', 'кадры', 'природопользование', 'окружающей среды',
        'экологическая безопасность', 'охрана памятников', 'здравоохранение', 'образование',
        'воспитание', 'наука', 'культура', 'физическая культура', 'спорт',
        'защита прав', 'национальные меньшинства', 'режим пограничных зон',
        'разграничение государственной собственности', 'социальная защита',
        'установление общих принципов', 'местное самоуправление', 'налоги и сборы субъектов',
        'природные ресурсы', 'земельное', 'водное', 'лесное', 'горное'
    ]
};
